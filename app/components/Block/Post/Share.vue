            ...
            <div class="bg-green-gray p-6 rounded-lg">
                ...
                <div class="relative w-fit">
                    <ul class="flex flex-wrap gap-3 !mb-0">
                        ...
                        <button @click="copyLink" class="group rounded-[5px] bg-transparent w-[38px] h-[38px] p-0 hover:bg-green-main transition duration-200 flex items-center justify-center cursor-pointer">
