<template>
  <div class="flex flex-col tablet:flex-row">
    <div class="relative max-w-[820px] basis-2/3 desktop-wide:basis-auto desktop-wide:shrink-0"
      ...
      <div class="w-full relative"
        ...
        <form name="contactForm" method="post" enctype="multipart/form-data" class="flex flex-col"
          ...
          <div class="flex flex-col mt-5 desktop:mt-10 transition" :class="{ 'opacity-0': mailSent }">
            <div class="prose font-normal text-xs desktop:text-sm max-w-[250px] mb-6 desktop:mb-10"
