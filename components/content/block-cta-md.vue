<template>
  ...
  >
    <BlockHeaderMdc
      class="no-padding text-center tablet:text-left z-20"
      :maxWidth="maxWidth"
      center
    >
      ...
      <template v-if="$slots.description" #description>
        <div
          class="description mb-4 text-base desktop:text-xl font-normal text-center"
        >
...
export default {
  ...
  props: {
    ...
    button: {
      type: Object,
      required: false,
      default: { link: "/", title: "Skontaktuj się", isWide: false },
    },
  },
};
</script>
