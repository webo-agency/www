<template>
  <div class="relative mb-20 tablet:mb-0">
    <ol class="mr-10 tablet:mr-20 max-w-2xl">
      <slot></slot>
    </ol>
    <div v-if="decoration" class="absolute -bottom-14 tablet:-bottom-12 -right-2 tablet:-left-3">
      <svg class="w-14 tablet:w-auto" width="96" height="128" viewBox="0 0 96 128" fill="none" xmlns="http://www.w3.org/2000/svg">
