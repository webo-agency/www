<template>
  <div class="px-5 tablet:px-10 desktop:px-20 overflow-hidden w-full">
    <div class="relative w-full mx-auto desktop:mx-auto max-w-screen-desktop-wide rounded-[5px]">
      <div
        ...
        <div class="max-w-screen-desktop-wide">
          <div ref="swiper" class="swiper swiper-container w-full h-full !overflow-visible">
            <div
