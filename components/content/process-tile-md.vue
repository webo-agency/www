<template>
  <div
    ...
    :class="[
      isWideType
        ? 'pr-7 tablet:basis-1/2'
        : 'pr-5 tablet:basis-[30%] desktop:basis-1/3',
    ]"
  >
    <EffectAppearMdc class="desktop-delay" :delay="number * 100">
      <div
        class="mb-5 desktop:mb-10"
        :class="[
          isWideType
            ? iconInline
              ? 'mr-2 tablet:mr-10'
      ...
      >
        <div>
          <div
            class="flex mb-2.5"
            :class="[
              !iconInline ? 'flex-col tablet:mb-5' : 'desktop:items-center',
            ]"
          >
            <span
              ...
              :class="
                ({ 'mb-2.5 tablet:mb-5': !iconInline },
                { 'bg-gradient-to-b from-[#ECF6F4] to-white': iconGradient })
              "
              >{{ number }}</span
            >
            <div
