<template>
  <div>
    <div class="flex flex-wrap relative " :class="[
      tilesTight ?
        '[&_>*]:basis-full [&_>*]:tablet:basis-1/2 [&_>*]:tablet-wide:basis-1/3 [&_>*]:desktop:basis-1/4 [&_>*]:pr-2.5 [&_>*]:tablet:pr-5 [&_.title]:!text-lg [&_.title]:desktop:!text-xl [&_.description]:!mb-0 [&_a]:desktop-wide:!pr-5'
        : '[&_>*]:basis-full [&_>*]:tablet:basis-1/2 [&_>*]:desktop:basis-1/3 [&_>*]:tablet:pr-5']">
      <slot> </slot>
    </div>
