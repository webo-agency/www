<template>
  <div class="relative">
    <div v-if="topNavigation" class="absolute hidden desktop-wide:block left-0 right-0 top-[-110px] px-5 tablet:px-10 desktop:px-20">
      <div class="mx-auto max-w-screen-desktop-wide">
        <div class="flex gap-5 justify-end">
          <div
            class="pointer-events-auto cursor-pointer desktop:flex items-center justify-center w-[50px] h-[50px] rounded-full bg-green-main hover:bg-green-mainHover transition duration-200"
            data-swiper-prev
          >
            <svg
    ...
    <div
      class="px-5 tablet:px-10 desktop:px-20 overflow-hidden"
    >
      <div
      ...
      >
        <div class="relative desktop-wide:w-screen pr-5 tablet:pr-10 desktop:pr-20 -mr-5 tablet:-mr-10 desktop:-mr-20 desktop-wide:mr-0 h-full overflow-hidden">
          <div
            class="max-w-screen-desktop-wide"
          >
            <div
              ref="swiper"
  ...
  data() {
    return {
      ...
      swiperOptionsObject: {
        ...
        breakpoints: this.disableSwiperBreakpoint ? {} : {
          1248: {
            slidesPerView: 3,
            grid: {
              fill: "row",
